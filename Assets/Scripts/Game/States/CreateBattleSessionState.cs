...
namespace Assets.Scripts.Infrasctucture.Gameplay.States
{
    public class CreateBattleSessionState : IState
    {
        ...
        public void Enter()
        {
            ...
            ITank tank1 = _tankFactory.CreateTank(spawnPoints[0].position, spawnPoints[0].rotation, Color.red);
            ITank tank2 = _tankFactory.CreateTank(spawnPoints[1].position, spawnPoints[1].rotation, Color.blue);
